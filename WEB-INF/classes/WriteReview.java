...
pw.print("<tr>");
					...
					pw.print("<td> <input type='text' name='manufacturerrebate' value='Yes'> </td>");
			        pw.print("</tr>");pw.print("<tr>");
					pw.print("<td> Product On Sale: </td>");
					pw.print("<td> <input type='text' name='productonsale' value='Yes'> </td>");
			        pw.print("</tr>");

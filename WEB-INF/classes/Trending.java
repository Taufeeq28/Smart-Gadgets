...
// 		pw.print("<td>" + best.getprice()+"</td>");
// 		//pw.print("</td>");
// 		pw.print("</tr>");
// 		pw.print("<tr>");
// 		pw.print("<td> Rating:</td>");
// 		pw.print("<td>"+best.getRating()+"</td>");
// 		pw.print("</tr>");
//         }
...
// 		pw.println("<td>"+most.getProductname()+"</td>");
// 		pw.println("</tr>");

// 		pw.println("<tr>");
// 		pw.print("<td> Price:</td>");
// 		//pw.println("<td>"+most.getPrice()+"</td>");
// 		pw.println("</tr>");

// 		//pw.println("<td border: 1px >");
// 		pw.println("<tr>");
// 		pw.print("<td> Number of Sold Products:</td>");
// 		pw.println("<td>"+most.getCount()+"</td>");
// 		pw.println("</tr>");

...
public class SaxParserDataStore extends DefaultHandler {
   ...
   //parse the xml using sax parser to get the data
	...
	if (element.equalsIgnoreCase("quantity")) {
			...
			if(currentElement.equals("wt"))
				wt.setQuantity(Double.parseDouble(elementValueRead));
			if(currentElement.equals("va"))
				va.setQuantity(Double.parseDouble(elementValueRead));
...
if (element.equalsIgnoreCase("manufacturerRebate")) {
			...
			if(currentElement.equals("wt"))
				wt.setManufacturerRebate(elementValueRead);
			if(currentElement.equals("va"))
				va.setManufacturerRebate(elementValueRead);
 ...
 public static void addHashmap() {
		...
		new SaxParserDataStore(TOMCAT_HOME+"//webapps//NewFinalAssignment//ProductCatalog.xml");
    } 
}
...
public class Login extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request,
		...
		try
		{		
        //   FileInputStream fileInputStream = new FileInputStream(new File(TOMCAT_HOME+"\\webapps\\NewFinalAssignment\\UserDetails.txt"));
	...
	protected void displayLogin(HttpServletRequest request,
		...
		if (error)
			pw.print("<h4 style='color:#a80000'>Please check your username, password and user type!</h4>");
		HttpSession session = request.getSession(true);
		...
		pw.print("<form method='post' action='Login'>"
				...
				+ "</td></tr><tr><td></td><td>"
				+ "<input type='submit' class='btnbuy' value='Login' style='float: right; margin-right: -18px; margin-top:10px; margin-bottom:10px'></input>"
				+ "</td></tr><tr><td></td><td>"
				+ "<strong><a class='' href='Registration' style='float: right;height: 20px margin: 20px; color:#a1a1a1'>New User?<span style='color:#a80000;'>Register Here!</span></a></strong>"
				+ "</td></tr></table>"
				+ "</form>" + "</div></div></div>");
